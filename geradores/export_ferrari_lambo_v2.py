#!/usr/bin/env python3
"""Exporta os 7 slides do carrossel Ferrari/Lambo v2 em 1080×1350px."""
import asyncio
from pathlib import Path
from playwright.async_api import async_playwright

INPUT  = Path("/home/user/Meu-espa-o/previews/nucvision-ferrari-lambo-v2.html")
OUT    = Path("/home/user/Meu-espa-o/output/ferrari-lambo-v2")
TOTAL  = 7
VW, VH = 420, 525
SCALE  = 1080 / 420
...
async def run():
    ...
    async with async_playwright() as p:
        ...
        for i in range(TOTAL):
            ...
            await page.screenshot(path=str(out), clip={"x": 0, "y": 0, "width": VW, "height": VH})
