#!/usr/bin/env python3
"""Exporta os 8 slides do carrossel Copa Hexa em 1080x1350px."""
import asyncio
from pathlib import Path
from playwright.async_api import async_playwright

INPUT = Path("/home/user/Meu-espa-o/previews/nucvision-copa-hexa.html")
OUT = Path("/home/user/Meu-espa-o/output/copa-hexa")
TOTAL = 8
VW, VH = 420, 525
SCALE = 1080 / 420
